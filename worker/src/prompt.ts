...
- archetype: classify the format (grwm_voiceover, pov_walk_and_talk, transformation_reveal, text_monologue, talking_head, skit, outfit_showcase — or a precise free-form label if none fit).
